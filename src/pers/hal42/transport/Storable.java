...
public class Storable{
  ...
  public enum Type{
    Unclassified, Null, Boolean, Enummy, WholeNumber, Floating, //as in mathematics
    Textual, Wad
  }

  public enum Origin{
    Ether, Defawlted, Parsed, Assigned
  }
...
//test rather than set                  child.setType(Type.Wad);//should already be true
  ...
  public void setValue(Object obj){
    ...
    if(obj instanceof String) {
      ...
      Stored attr = obj.getClass().getAnnotation(Stored.class);
      if(attr != null) {
        Storable.Nodal loader = new Storable.Nodal<>(this, obj);//constructor has side effects.
      } else {
